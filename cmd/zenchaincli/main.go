...
import (
	...
	tokencmd "github.com/zenchainprotocol/zenchain-node/x/token/client/cli"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "zenchaincli",
		Short: "Command line interface for interacting with zenchaind",
	}
	...
	// Add flags and prefix all env exposed with zenchain
	executor := cli.PrepareMainCmd(rootCmd, "zenchain", app.DefaultCLIHome)
