...
import (
	...
	"github.com/zenchainprotocol/zenchain-node/app/codec"
	...
	"github.com/zenchainprotocol/zenchain-node/cmd/client"
	"github.com/zenchainprotocol/zenchain-node/x/genutil"
	genutilcli "github.com/zenchainprotocol/zenchain-node/x/genutil/client/cli"
	genutiltypes "github.com/zenchainprotocol/zenchain-node/x/genutil/types"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:               "zenchaind",
		Short:             "zenchain App Daemon (server)",
	...
	executor := cli.PrepareBaseCmd(rootCmd, "zenchain", app.DefaultNodeHome)
...
func exportAppStateAndTMValidators(
	...
	var ethermintApp *app.zenchainApp
	if height != -1 {
		ethermintApp = app.NewzenchainApp(logger, db, traceStore, false, map[int64]bool{}, 0)

		if err := ethermintApp.LoadHeight(height); err != nil {
			return nil, nil, err
		} else {
			ethermintApp = app.NewzenchainApp(logger, db, traceStore, true, map[int64]bool{}, 0)
		}
	}
