...
func GetCmdDestroyValidator(cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		...
		Args:  cobra.NoArgs,
		Short: "deregister the validator from the zenChain and unbond the min self delegation",
		Long: strings.TrimSpace(
			fmt.Sprintf(`Deregister the validator from the zenChain and unbond the min self delegation.
	...
	return &cobra.Command{
		...
		Long: strings.TrimSpace(
			fmt.Sprintf("Add shares to one or more validators by all deposited %s.\n\nExample:\n$ %s tx staking add-shares "+
				"zenchainvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg,"+
				"zenchainvaloper1svzxp4ts5le2s4zugx34ajt6shz2hg42dnwst5,"+
				"zenchainvaloper10q0rk5qnyag7wfvvt7rtphlw589m7frshchly8,"+
				"zenchainvaloper1g7znsf24w4jc3xfca88pq9kmlyjdare6tr3mk6 --from mykey\n",
...
Example:
$ %s tx staking proxy bind zenchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0 --from mykey
`,
				version.ClientName),
		),
		RunE: func(cmd *cobra.Command, args []string) error {
