...
import (
	...
	"github.com/zenchainprotocol/zenchain-node/x/gov/client/utils"
...
Example:
$ %s query gov proposals --depositor zenchain1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ %s query gov proposals --voter zenchain1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
...
Example:
$ %s query gov vote 1 zenchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query gov deposit 1 zenchain1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`,
				version.ClientName,
			),
		),
