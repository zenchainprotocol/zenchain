...
import (
	...
	"github.com/zenchainprotocol/zenchain-node/x/token/legacy/v0_10"
)
...
type (
	...
	Token struct {
		...
		Owner               sdk.AccAddress `json:"owner" v2:"owner"`                                 // e.g. zenchain1upyg3vl6vqaxqvzts69zpus2c027p7paw63s99
