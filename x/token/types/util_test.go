...
func TestStrToTransfers(t *testing.T) {
	...
	coinStr := `[{"to":"zenchain1dfpljpe0g0206jch32fx95lyagq3z5ws850m6f","amount":"1` + common.NativeToken + `"}]`
	...
	coinStr = `[{"to":"zenchain1dfpljpe0g0206jch32fx95lyagq3z5ws850m6f",amount":"1"}]`
