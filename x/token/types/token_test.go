...
func TestToken(t *testing.T) {
	...
	common.InitConfig()
	addr, err := sdk.AccAddressFromBech32("zenchain1dfpljpe0g0206jch32fx95lyagq3z5ws850m6f")
	require.Nil(t, err)
	...
	testCase := []struct {
		...
		{Token{
			...
			Owner:               addr,
			Mintable:            true,
		}, `{"description":"okblockchain coin","symbol":"` + common.NativeToken + `","original_symbol":"` + common.NativeToken + `","whole_name":"ok coin","original_total_supply":"1000000000.000000000000000000","type":0,"owner":"zenchain1dfpljpe0g0206jch32fx95lyagq3z5ws850m6f","mintable":true}`},
	}
