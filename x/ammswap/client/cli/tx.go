...
Example:
$ zenchaincli tx swap add-liquidity --max-base-amount 10eth-355 --quote-amount 100btc-366 --min-liquidity 0.001
...
Example:
$ zenchaincli tx swap remove-liquidity --liquidity 1 --min-base-amount 10eth-355 --min-quote-amount 1btc-366
...
Example:
$ zenchaincli tx swap create-pair --token0 eth-355 --token1 btc-366 --fees 0.01okt 
...
Example:
$ zenchaincli tx swap token --sell-amount 1eth-355 --min-buy-amount 60btc-366
