...
var (
	pattern_Query_Bid_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"zenchainprotocol", "zenchain", "auction", "bid", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BidAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"zenchainprotocol", "zenchain", "auction", "bid"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Order_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"zenchainprotocol", "zenchain", "auction", "order", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OrderAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"zenchainprotocol", "zenchain", "auction", "order"}, "", runtime.AssumeColonVerbOpt(true)))
)
