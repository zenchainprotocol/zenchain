...
Example:
$ %s tx distr set-withdraw-addr zenchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0 --from mykey
`,
				version.ClientName,
			),
		),
...
func GetCmdWithdrawRewards(cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: strings.TrimSpace(
			fmt.Sprintf(`
Example:
$ %s tx distr withdraw-rewards zenchainvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey 
`,
				version.ClientName,
			),
		),
...

{
  ...
  "recipient": "zenchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0",
  "amount": [
    {
      "denom": "%s",
      "amount": "10000"
