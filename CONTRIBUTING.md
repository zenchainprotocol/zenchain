...
Thank you for considering making contributions to zenChain and related
repositories!
...
1. Either [open](https://github.com/zenchainprotocol/zenchain-node/issues/new/choose) or
   [find](https://github.com/zenchainprotocol/zenchain-node/issues) an issue you'd like to help with
...
3. If you would like to contribute:
   ...
   4. Follow standard Github best practices: fork the repo, branch from the
      ...
      - For core developers working within the zenChain repo, to ensure a clear
...
Take a peek at our [coding repo](https://github.com/zenchainprotocol/coding) for
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/zenchainprotocol/zenchain-node/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
While my fork lives at `https://github.com/rigeyrigerige/zenchain`,
the code should never exist at  `$GOPATH/src/github.com/rigeyrigerige/zenchain`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/zenchainprotocol/zenchain-node `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/zenchainprotocol/zenchain-node`)
  - `git remote rename origin upstream`
  - `git remote add origin git@github.com:rigeyrigerige/zenchain.git`

Now `origin` refers to my fork and `upstream` refers to the zenChain version.
So I can `git push -u origin master` to update my fork, and make pull requests to zenChain from there.
...
### Development Procedure
  ...
  - create a development branch either on github.com/zenchainprotocol/zenchain-node, or your fork (using `git remote add origin`)
