...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryOrderAll
   * @request GET:/zenchainprotocol/zenchain/auction/order
   */
  queryOrderAll = (
    query?: {
    ...
    this.request<AuctionQueryAllOrderResponse, RpcStatus>({
      path: `/zenchainprotocol/zenchain/auction/order`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryOrder = (id: string, params: RequestParams = {}) =>
    this.request<AuctionQueryGetOrderResponse, RpcStatus>({
      path: `/zenchainprotocol/zenchain/auction/order/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
