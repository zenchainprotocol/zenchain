...
// transactions. There should only be a single implementation in zenChain. For
// the purposes of zenChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: zenChain will distribute the fees out to validators, so the structure
