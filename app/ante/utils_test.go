...
import (
	...
	ante "github.com/zenchainprotocol/zenchain-node/app/ante"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.ctx = suite.app.BaseApp.NewContext(checkTx, abci.Header{Height: 1, ChainID: "zenchain-3", Time: time.Now().UTC()})
...
func newTestCoins() sdk.Coins {
	return sdk.NewCoins(zenchain.NewPhotonCoinInt64(500000000))
}

func newTestStdFee() auth.StdFee {
	return auth.NewStdFee(220000, sdk.NewCoins(zenchain.NewPhotonCoinInt64(150)))
}
...
func newTestEthTx(ctx sdk.Context, msg evmtypes.MsgEthereumTx, priv tmcrypto.PrivKey) (sdk.Tx, error) {
	chainIDEpoch, err := zenchain.ParseChainID(ctx.ChainID())
	if err != nil {
		return nil, err
	}
