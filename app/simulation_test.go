...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewzenChainApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewzenChainApp(log.NewNopLogger(), newDB, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numTimesToRunPerSeed; i++ {
		...
		app := NewzenChainApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, interBlockCacheOpt())
